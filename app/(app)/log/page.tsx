        ...
        return (
            <div className="space-y-6">
                ...
                <Card>
                    ...
                    <CardContent>
                        <Table>
                            <TableHeader><TableRow><TableHead>Time</TableHead><TableHead>Method</TableHead><TableHead>Person</TableHead><TableHead>Res</TableHead><TableHead>FollowUp</TableHead></TableRow></TableHeader>
                            <TableBody>
                                {outreach.map(o => (
                                    <TableRow key={o._id}>
                ...
                <Card>
                    ...
                    <CardContent>
                        <Table>
                            <TableHeader><TableRow><TableHead>Customer</TableHead><TableHead>Service</TableHead><TableHead>Amount</TableHead><TableHead>Paid?</TableHead><TableHead>Referral?</TableHead></TableRow></TableHeader>
                            <TableBody>
                                {jobs.map(j => (
                                    <TableRow key={j._id}>
                        ...
                        <Form {...useForm<ExpenseFormValues>({ resolver: zodResolver(expenseSchema), defaultValues: { expenses: log.expensesToday } })}>
                            <form
                                onSubmit={(e) => {
                                    ...
                                    updateExpenses({ logId: log._id, expenses }).catch(err => toast.error((err as Error).message));
                                }}
